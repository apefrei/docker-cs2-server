...
ENV GAMEMODESURL "https://raw.githubusercontent.com/apefrei/butterlan-gameserver-configs/main/cs2/gamemodes_server.txt"
...
ENV CS2_SERVERNAME="Butterlan CS2 Server" \
    CS2_CHEATS=0 \
    CS2_IP=0.0.0.0 \
